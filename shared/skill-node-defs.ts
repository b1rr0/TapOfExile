...
export const MINOR_POOL: NodeDef[] = [
  ...
  minor("min_hit_30",   "+20 Hit (tap)",        flat("tapHit", 20)),
  ...
  minor("min_hit_40",   "+20 Hit (tap)",        flat("tapHit", 20)),
];
...
export const NOTABLE_POOL: NodeDef[] = [
  ...
  notable("not_battlecry",  "+15% Dmg, +33 Hit",         "Battle Cry",      pct("damage", 0.15), flat("tapHit", 33)),
...
export const KEYSTONE_POOL: NodeDef[] = [
  ...
  // ── Set 3: dual-stat (8) ──
  keystone("ks_pyro",       "+40% Fire, +50 Hit",    "Pyromancer",         pct("fireDmg", 0.40), flat("tapHit", 50)),
  ...
  keystone("ks_nightblade", "+60% Crit Dmg, +50 Hit","Nightblade",         pct("critMulti", 0.60), flat("tapHit", 50)),
  ...
  keystone("ks_frenzy",     "+50 Hit, +15% Dmg",     "Blood Frenzy",       flat("tapHit", 50), pct("damage", 0.15)),
...
export const CLASS_SKILLS: Record<string, NodeDef[]> = {
  ...
  mage: [
    ...
    classSkill("mag_void",      "+20% Pure Dmg, +33 Hit",          "Void Rift",       pct("pureDmg", 0.20), flat("tapHit", 33)),
  ...
  archer: [
    ...
    classSkill("arc_volley",    "+20% Dmg, +50 Hit",               "Volley",          pct("damage", 0.20), flat("tapHit", 50)),
