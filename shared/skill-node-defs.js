...
exports.CLASS_SKILLS = exports.KEYSTONE_POOL = exports.NOTABLE_POOL = exports.MINOR_POOL = exports.STAT_TO_PLAYER = exports.NodeDef = exports.StatModifier = void 0;
exports.pct = pct;
exports.flat = flat;
exports.minor = minor;
...
exports.computeAllocatedBonuses = computeAllocatedBonuses;
class StatModifier {
    stat;
    value;
    mode;
...
function computeAllocatedBonuses(nodes, allocated) {
    const percent = {};
    const flat = {};
    for (const nodeId of allocated) {
        ...
        if (mods && mods.length > 0) {
            for (const mod of mods) {
                const key = exports.STAT_TO_PLAYER[mod.stat] || mod.stat;
                if (mod.mode === "flat") {
            ...
            const key = exports.STAT_TO_PLAYER[node.stat] || node.stat;
            percent[key] = (percent[key] || 0) + node.value;
        }
    }
    return { percent, flat };
}
//# sourceMappingURL=skill-node-defs.js.map