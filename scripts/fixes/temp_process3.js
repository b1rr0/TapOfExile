...
const BASE_SRC = 'D:/programs/code/TapOfExile/shared/public/assets/skils_sprites/not_processed';
...
processSlash(path.join(BASE_SRC, 'Slash 1'), 'slash_arc', 9, slashColorMap, 640, 256, 128, 128, 540, 200, 200);
processSlash(path.join(BASE_SRC, 'Slash 2'), 'slash_cross', 7, slashColorMap, 640, 256, 128, 128, 420, 200, 200);
processSlash(path.join(BASE_SRC, 'Slash 3'), 'slash_sweep', 9, slashColorMap, 640, 256, 128, 128, 540, 200, 200);
