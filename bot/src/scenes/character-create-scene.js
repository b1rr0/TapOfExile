...
export class CharacterCreateScene {
  ...
  mount(params = {}) {
    ...
    const classCards = this.container.querySelectorAll(".class-card");
    classCards.forEach(card => {
      card.addEventListener("click", () => {
        ...
        this._selectedClassId = card.dataset.class;
    ...
    // Wire nickname input
    const nicknameInput = this.container.querySelector("#cc-nickname");
    nicknameInput.addEventListener("input", () => this._updateConfirmState());

    // Wire confirm button
    this.container.querySelector("#cc-confirm").addEventListener("click", () => {
  ...
  async _loadClassPreviews() {
    const canvases = this.container.querySelectorAll(".class-card__preview");
  ...
  async _loadBigPreview(classId) {
    ...
    const canvas = this.container.querySelector("#cc-preview");
    if (!canvas) return;
  ...
  _updateConfirmState() {
    const nickname = this.container.querySelector("#cc-nickname")?.value.trim();
    const btn = this.container.querySelector("#cc-confirm");
    if (btn) {
