...
export const ACT_MODIFIERS: Record<number, ActModifier[]> = {
  ...
  1: [
    ...
    { icon: "\u2694\uFE0F",         name: "Armory Access", description: "+5% hit damage from nearby weapons",     type: "buff",   stat: "damage",      target: "self",  value: 0.05 },
  ...
  3: [
    { icon: "\uD83D\uDCA8",         name: "Tailwind",       description: "+5% hit damage from favorable winds",          type: "buff",   stat: "damage",              target: "self",  value: 0.05 },
  ...
  4: [
    ...
    { icon: "\u2744\uFE0F",         name: "Frostbite",    description: "-8% hit damage from extreme cold",              type: "debuff", stat: "damage",      target: "self", value: -0.08 },
  ...
  5: [
    ...
    { icon: "\u2620\uFE0F",         name: "Toxic Fumes",   description: "-5% hit damage from noxious gas",              type: "debuff", stat: "damage",      target: "self", value: -0.05 },
  ],
};
