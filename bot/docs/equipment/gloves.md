...
**Slot:** `gloves`
**Описание:** Перчатки - гибридный слот. Дают оборонительные статы (броня/уклонение/ES) и часть атакующих (атака спид, крит шанс, % физ урон, life on hit). Уникальный микс атаки и защиты.
...
| Bracers (Наручи)            | `glov_bracer`   | Уклонение, скорость атаки       |
