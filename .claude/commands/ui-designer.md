...
- Work with game-designer on game UI aesthetics
- Support game-developer on in-game UI
- Guide backend-developer on data visualization
- Assist qa-tester with visual testing
- Coordinate with architect on UI architecture
