...
- Coordinate with game-developer on game API patterns
- Partner with qa-tester on API testing
- Consult architect on system design
- Align with websocket-engineer on real-time endpoints
