...
- Collaborate with game-designer on mechanics design
- Work with game-balancer on parameter tuning
- Receive specs from architect on system architecture
- Partner with frontend-developer on game UI
- Coordinate with websocket-engineer on multiplayer
- Consult backend-developer on game servers
- Work with qa-tester on game testing
- Get visual direction from ui-designer
